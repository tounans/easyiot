...
import com.tounans.easyiot.common.client.EasyIotServerList;
...
@Service
public class AuthServerImpl implements IAuthService {
    ...
    private AuthToken applyToken(String username, String password, String clientId, String clientSecret){
        ...
        ServiceInstance serviceInstance = loadBalancerClient.choose(EasyIotServerList.SERVER_AUTH);
        //此地址就是http://ip:port
