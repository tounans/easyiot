package com.tounans.easyiot.easyiotpush.service.impl;
...
import com.tounans.easyiot.easyiotpush.mapper.PushHttpMapper;
...
public class PushHttpServiceImpl extends ServiceImpl<PushHttpMapper, PushHttp> implements IPushHttpService {
    ...
    @Override
    public IPage<PushHttp> pageByUserParam(Integer page,Integer pageSize, Integer userId) {
