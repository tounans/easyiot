...
public interface DeviceGpioLogMapper extends BaseMapper<DeviceGpioLog> {
    ...
    @Select("SELECT\n" +
            ...
            "FROM\n" +
            "iot_device_gpio_log\n" +
            "LEFT JOIN iot_device_gpio ON iot_device_gpio_log.user_id = iot_device_gpio.user_id AND iot_device_gpio_log.gpio_id = iot_device_gpio.user_gpio_id AND iot_device_gpio_log.device_id = iot_device_gpio.device_id\n" +
